...
def get_movies_page_content(movies_page_url) -> BeautifulSoup:
    page_data = requests.get(movies_page_url)
...
def scrape_movie_scripts(movies_page_url):
    soup_page_parser = get_movies_page_content(movies_page_url)
